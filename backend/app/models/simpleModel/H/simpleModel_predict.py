...
from app.models.simpleModel.H.model_utils import predict_associations
...
def predict(smiles):
    ...
    try:
        ...
        if feats_df.empty:
            print("No H groups detected in this SMILES.")
            raise Exception("No H groups detected in this SMILES.")
